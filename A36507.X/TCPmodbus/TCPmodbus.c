...
#define ETHERNET_CMD_GUN_DRIVER_EK_SET_POINT			 5
#define ETHERNET_CMD_GUN_DRIVER_EF_SET_POINT			 6
#define ETHERNET_CMD_GUN_DRIVER_EG_SET_POINT			 7
...
void ExecuteCommands(void) {
  ...
  if (command_data_count != command_count) {
    ...
    case ETHERNET_CMD_GUN_DRIVER_EK_SET_POINT:
		etm_can_gun_driver_mirror.gun_cathode_voltage_set_point = command_data_data;
	break;

    case ETHERNET_CMD_GUN_DRIVER_EF_SET_POINT:
		etm_can_gun_driver_mirror.gun_heater_voltage_set_point = command_data_data;
	break;

    case ETHERNET_CMD_GUN_DRIVER_EG_SET_POINT:
		etm_can_gun_driver_mirror.gun_high_energy_pulse_top_voltage_set_point = command_data_data;
	break;
